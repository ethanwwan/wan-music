...
- Name: ui.spec.js >> wan-music UI 测试套件 >> 音质选择功能
- Location: tests/ui.spec.js:89:3
...
Locator:  locator('.quality-selector').first().locator('text=无损').first()
Expected: visible
Received: hidden
Timeout:  5000ms
...
Call log:
  ...
  - waiting for locator('.quality-selector').first().locator('text=无损').first()
    14 × locator resolved to <el-radio-button value="2" data-v-bfc8e12b="">{↵  "value": "lossless",↵  "label": "无损",↵  "bitr…</el-radio-button>
