...
const FALLBACK = {
  ...
  qualities: [
    { value: 'jymaster', label: '超清母带', description: 'FLAC 24bit/96kHz', priority: 1, format: 'FLAC 24bit/96kHz' },
    { value: 'jysurround', label: '臻音全景声', description: 'Surround 3D Audio', priority: 2, format: 'Surround 3D' },
    { value: 'dolby', label: '杜比全景声', description: 'Dolby Atmos', priority: 3, format: 'Dolby Atmos' },
    { value: 'sky', label: '沉浸环绕声', description: 'Surround Audio', priority: 4, format: 'Surround' },
    { value: 'jyeffect', label: '高清环绕声', description: 'Spatial Audio', priority: 5, format: 'Spatial' },
    { value: 'hires', label: 'Hi-Res音质', description: 'FLAC 24bit', priority: 6, format: 'FLAC 24bit' },
    { value: 'lossless', label: '无损音质', description: 'FLAC', priority: 7, format: 'FLAC' },
    { value: 'exhigh', label: '极高音质', description: '320kbps', priority: 8, format: 'MP3/AAC' },
    { value: 'standard', label: '标准音质', description: '128kbps', priority: 9, format: 'MP3' },
  ],
  filename_formats: [
